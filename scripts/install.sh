...
load_vars() {
	...
	VERSION=$(get_latest_release "midoks/simdht")

	TARGET_DIR="/usr/local/simdht"
}
...
get_download_url() {
	DOWNLOAD_URL="https://github.com/midoks/simdht/releases/download/$VERSION/simdht_${VERSION}_${OS}_${ARCH}.tar.gz"
}
